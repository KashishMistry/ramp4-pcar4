...
import { co as defineComponent, cq as inject, cs as resolveComponent, cu as openBlock, cv as createBlock, cw as withCtx, fG as createBaseVNode, iM as normalizeStyle, cx as createTextVNode, cp as useI18n, cy as toDisplayString, cz as unref, cj as FixtureInstance, hs as markRaw } from './main-942c0e56.js';
        ...
        config: {
          screens: {
            ...
            "p-2-screen-1": () => {
              return new Promise(
                (resolve) => setTimeout(
                  () => __vitePreload(() => import('./p2-screen-1-a745f55b.js'),true?["./p2-screen-1-a745f55b.js","./main-942c0e56.js","./preload-helper-a4975f27.js","./main-2af48127.css"]:void 0,import.meta.url).then(
                    (data) => {
                      resolve(data);
                    }
                  ),
